...
namespace Spotifake
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Song song1 = new(artist1, 140, "pop", "'O trerrote", "21-02-1997");
            Album album1 = new("Monnezzarium", "21-02-1997", 10, false, artist1, song1);
            ...
            while (true){
                ...
                switch (check)
                {
                    ...
                    case "C": database.SearchSong();break;//to do
